...
# --------------------define variables-------------------
OUTPUT_FILE = 'karnataka_2015.csv'
PDF_FOLDER = 'karnataka_2015/'
...
class KarnatakaScraper:
    ...
    def GetDistrictList(self):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll_2015/Dist_List.aspx'
    ...
    def GetACList(self, district_no):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll_2015/AC_List.aspx'
    ...
    def GetPSList(self, ac_no):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll_2015/Part_List.aspx'
        ...
        for district in district_list:
            ...
            for ac in ac_list:
                ...
                for ps in ps_list:
                    ...
                    draft_roll_pdf_url = 'http://ceokarnataka.kar.nic.in/FinalRoll_2015/Kannada/WOIMG/AC%s/%s' % (
                        str('{0:03d}'.format(int(ac['no']))),
                        file_name
                    )
