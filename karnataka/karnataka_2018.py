...
# --------------------define variables-------------------
OUTPUT_FILE = 'karnataka_2018.csv'
PDF_FOLDER = 'karnataka_2018/'
...
class KarnatakaScraper:
    ...
    def GetDistrictList(self):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll-2018/Dist_List.aspx'
    ...
    def GetACList(self, district_no):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll-2018/AC_List.aspx'
    ...
    def GetPSList(self, ac_no):
        # set url
        url = 'http://ceokarnataka.kar.nic.in/FinalRoll-2018/Part_List_2018.aspx'
        ...
        for district in district_list:
            ...
            for ac in ac_list:
                ...
                for ps in ps_list:
                    ...
                    draft_roll_pdf_url = 'http://ceokarnataka.kar.nic.in/FinalRoll-2018/Kannada/AC%s/%s' % (
                        str('{0:03d}'.format(int(ac['no']))),
                        file_name
                    )
